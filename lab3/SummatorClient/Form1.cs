...
namespace SummatorClient
{
    ...
    {
        private ISummatorRemoveService _instance;
        public Form1()
        {
            InitializeComponent();
            ...
            _instance = (ISummatorRemoveService)Activator.GetObject(typeof(ISummatorRemoveService), "tcp://localhost:51495/Summator");
        }
